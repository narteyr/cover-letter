...
import { NavSidebarFooter } from "../base-components/nav-sidebar-footer";
import { NavItemBase } from "../base-components/nav-item";
import { NavList } from "../base-components/nav-list";
import type { NavItemType } from "../config";
import InternalyLogo from "@/components/foundations/logo/company-logo";
...
export const SidebarNavigationSimple = ({
    ...
    const content = (
        <aside
            ...
            className={cx(
                "flex h-full w-full max-w-full flex-col justify-between overflow-auto bg-primary/95 pt-4 lg:w-(--width) lg:pt-6",
        ...
        >
            ...
            <div className="mt-auto flex flex-col gap-4 px-2 py-4 lg:px-4 lg:py-6">
                ...
                {showAccountCard && <NavSidebarFooter />}
            </div>
        </aside>
    );
