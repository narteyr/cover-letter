...
const PresetButton = ({ value, children, ...props }: HTMLAttributes<HTMLButtonElement> & { value: CalendarDate }) => {
    ...
    const handleClick = () => {
        // Type assertion for @internationalized/date version compatibility (parent 3.10 vs cover-letter 3.11)
        context.setValue(value as never);
        context.setFocusedDate(value as never);
    };
