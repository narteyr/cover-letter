...
export const CalendarCell = ({ date, isHighlighted, ...props }: CalendarCellProps) => {
    ...
    // Type assertion for @internationalized/date version compatibility (3.10 vs 3.11)
    const dayOfWeek = getDayOfWeek(date as never, locale);
    ...
    const isTodayDate = isToday(date as never, getLocalTimeZone());
