...
type KeyboardModifiers = { alt: boolean; ctrl: boolean; shift: boolean; meta: boolean; mod: boolean; useKey: boolean };
type Hotkey = KeyboardModifiers & { keys: string[]; description?: string; isSequence: boolean; hotkey: string };
